...
import com.pavan.example.zoo.impl.ZKClientManagerImpl;
...
public class ZKClientTest {
	...
	// ZNode Path
	private String path = "/First-node";
	byte[] data = "ZK Client Data".getBytes();
	...
	public void testUpdate() throws KeeperException, InterruptedException {
		zkmanager.create(path, data);
		String data = "First Node Updated Data";
